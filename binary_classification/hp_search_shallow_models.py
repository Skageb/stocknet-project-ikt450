...
from dataset_loaders_refactored import NormSentimentNormPriceXPriceY, TwitterSentimentVolumePriceXPriceY
from models import LSTM_1_FC_2, BILSTM_1_FC_2, RNN_1_FC_2, GRU_1_FC_2
...
def objective(trial):
    ...
    model = trial.suggest_categorical('MODEL', ['GRU_1_FC_2', 'LSTM_1_FC_2', 'BILSTM_1_FC_2', 'RNN_1_FC_2'])
    ...
    model_dict = {'GRU_1_FC_2': GRU_1_FC_2, 'LSTM_1_FC_2': LSTM_1_FC_2, 'BILSTM_1_FC_2': BILSTM_1_FC_2, 'RNN_1_FC_2': RNN_1_FC_2}
...
if __name__ == '__main__':
    ...
    study = optuna.create_study(
        study_name=f"OVERNIGHT_1Recurrent_2FC_dataset_{cfg.dataloader.__name__}",
    ...
    cfg.dataloader = NormSentimentNormPriceXPriceY
