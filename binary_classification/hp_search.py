...
def train(model, cfg, train_data, train_dataloader, eval_dataloader, test_dataloader, trial=None):
...
def objective(trial):
    ...
    learning_rate = trial.suggest_float('LEARNING_RATE', 5e-5, 5e-2)
    ...
    #Train the model
    log_object = train(model, cfg, train_dataset, train_dataloader, eval_dataloader, test_dataloader, trial=trial)
...
if __name__ == '__main__':
    ...
    study = optuna.create_study(
        study_name=f"FinalExperiment_{cfg.dataloader.__name__}",
